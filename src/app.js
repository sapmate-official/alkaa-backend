...
import { allowedOrigins, corsOptions } from './util/corsOptions.js'
...
// API Routes
import manager from './router/v1/manager.router.js'
import employee from './router/v1/employee.router.js'
import general from './router/v1/general.router.js'
import leave from './router/v1/leave.router.js'
import attendance from './router/v1/attendance.router.js'
import salary from './router/v1/salary.router.js'
import authRouter from './router/v1/auth.router.js'
...
import mainV2Router from './router/v2/main.router.js'
import mainv3Router from './router/v3/main.router.js'
import validateTokenMiddlewear from './middleware/validateToken.js'
// import apiService from './router/api/main.router.js'
...
import { getBillById, processBillPayment } from './controller/v2/superAdmin/superAdmin.controller.js';
